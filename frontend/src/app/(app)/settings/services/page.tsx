...
export default function ServicesSettingsPage() {
  ...
  function saveService() {
    ...
    if (editingService) { updateService(editingService.id, serviceForm); toast.success("Service updated"); }
    else { addService({ ...serviceForm, status: "ACTIVE" }); toast.success("Service created"); }
  ...
  function saveCourse() {
    ...
    if (editingCourse) { updateCourseTemplate(editingCourse.id, courseForm); toast.success("Course updated"); }
    else { addCourseTemplate({ ...courseForm, status: "ACTIVE" }); toast.success("Course created"); }
    setCourseOpen(false);
  }
                    ...
                    <TableRow key={s.id} className="[&>td]:py-3.5">
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Switch checked={s.status === "ACTIVE"} onCheckedChange={() => toggleServiceStatus(s.id)} />
                        </div>
                      </TableCell>
                    </TableRow>
                  ))}
                    ...
                    <TableRow key={c.id} className="[&>td]:py-3.5">
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Switch checked={c.status === "ACTIVE"} onCheckedChange={() => toggleCourseTemplateStatus(c.id)} />
                        </div>
                      </TableCell>
                    </TableRow>
                  ))}
