...
export default function ResourcesSettingsPage() {
  ...
  function save() {
    if (!form.name) return;
    if (editing) { updateResource(editing.id, form); toast.success("Resource updated"); }
    else { addResource({ ...form, status: "ACTIVE" }); toast.success("Resource created"); }
    setOpen(false);
  }
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Switch checked={r.status === "ACTIVE"} onCheckedChange={() => toggleResourceStatus(r.id)} />
                        </div>
                      </div>
                    );
                  })}
